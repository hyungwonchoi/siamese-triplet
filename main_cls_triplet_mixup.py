...
from losses import TripletLoss, TripletLoss_Mixup, TripletLoss_Mixup_single
...
fit(False, writer, args, triplet_train_loader, triplet_test_loader, model, triplet_loss_fn, optimizer, scheduler, args.epoch, cuda, args.log_interval, val_loader_cls=test_loader, val_loader_emb=triplet_test_loader, use_mixup=True)
writer.close()
