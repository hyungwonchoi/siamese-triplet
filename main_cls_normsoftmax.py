...
writer = SummaryWriter("./visual/{}/{}/normsoft_nfeat_{}_triplet_{}_lr_{}_ntry{}".format(args.dataset, args.type, args.nfeat, args.triplet, args.lr, args.ntry))
...
from networks import EmbeddingNet, ClassificationNet, EmbeddingNet_ResNet, ClassificationNet_normsoftmax
from metrics import AccumulatedAccuracyMetric

embedding_net = EmbeddingNet_ResNet(args.nfeat, args.nchannel)
model = ClassificationNet_normsoftmax(embedding_net, n_classes=n_classes, nfeat=args.nfeat)
if cuda:
    model.cuda()
...
if args.save_embedding == True:
    ...
    fit(clsonly, writer, args, train_loader, test_loader, model, loss_fn, optimizer, scheduler, args.epoch, cuda, args.log_interval, metrics=[AccumulatedAccuracyMetric()], val_loader_emb=triplet_test_loader, normsoft=True)
